jQuery(function($){
    ...
    $(document).on('click', '.update-product-button', function(){
        ...
        $.getJSON("http://phpmvc/api/product/read_one.php?id=" + id, function(data){
            ...
            $.getJSON("http://phpmvc/api/category/read.php", function(data){
    ...
    $(document).on('submit', '#update-product-form', function(){
        ...
        $.ajax({
            url: "http://phpmvc/api/product/update.php",
            type : "POST",
